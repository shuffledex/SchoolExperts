//;(function () {
	...
	var dappAddress = "n22Jbhea3XJHBircZGZR1deNLS9riHbdHVA";
	...
	function getExperts() {
		...
		var to = dappAddress;
		var value = 0;
		var callFunction = "getAllExperts";
		var callArgs = null;
		...
		nebPay.simulateCall(to, value, callFunction, callArgs, {
			...
			listener: getExpertsListener
		});
	};

	function getExpertsListener(response) {
		if (response.execute_err == "" || response.execute_err == "insufficient balance") {
			var result = JSON.parse(response.result);
			$('.owl-carousel-carousel').html("");
